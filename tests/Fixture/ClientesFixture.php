...
class ClientesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'usuário_UNIQUE' => ['type' => 'unique', 'columns' => ['username'], 'length' => []],
            'telefone_UNIQUE' => ['type' => 'unique', 'columns' => ['phone'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'modified' => '2022-10-22 19:44:51',
                'created' => '2022-10-22 19:44:51',
            ],
        ];
        parent::init();
    }
